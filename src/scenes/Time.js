class Time extends Phaser.Scene {
  ...
  create() {
    ...
    this.tutorialText = this.add.bitmapText(this.tutorialPanel.x, this.tutorialPanel.y, 'dialogW',`RUSH: \nGet Mia to Lance's before time runs out!\nHitting cars will slow you down. Your vision is also limited.`, 20).setDepth(101).setOrigin(.5).setDepth(5);
